...
class HorizontalMenuItem extends StatelessWidget {
  ...
  const HorizontalMenuItem({ this.itemName, this.onTap }) ;
                    ...
                    child: Row(
                      children: [
                       ...
                       SizedBox(width:_width / 88),
                        ...
                        Flexible(child: CustomText(text: itemName , color: menuController.isHovering(itemName!) ? dark : Color(0xFF91A3B0),))
                        else
